...
const JobOrderForm = (props) => {
  const { data, closeModal, joSeries } = props;
          ...
          <Spin spinning={isSubmitting} tip="Submitting">
            <Form>
              {checkMethod === "ADD" && (
                <Checkbox
                  ...
                  onChange={(e) =>
                    setValues({
                      ...values,
                      jo_num: values.seriesNumber,
                      useSeries: !values.useSeries,
                    })
                  }
                >
                  USE SERIES
              ...
              <Field
                ...
                value={
                  values.date_issued
                    ? moment(values.date_issued, "YYYY-MM-DD")
                    : null
                }
              ...
              <Field
                ...
                value={
                  values.date_needed
                    ? moment(values.date_needed, "YYYY-MM-DD")
                    : null
                }
                format="YYYY-MM-DD"
              ...
              <Checkbox
                ...
                onChange={(e) =>
                  setFieldValue("forwardToWarehouse", e.target.checked)
                }
              >
